...
class CustomPipeline(LLM, BaseModel):
    ...
    def __init__(self, model_id):
        ...
        elif model_id == "falcon-40b":
            #model = pipeline(model="tiiuae/falcon-40b",torch_dtype=torch.bfloat16, trust_remote_code=True, device_map=device_map)
            model = AutoModelForCausalLM.from_pretrained("tiiuae/falcon-40b",torch_dtype=torch.bfloat16, trust_remote_code=True, device_map=device_map)
